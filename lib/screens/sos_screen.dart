...
class _SosScreenState extends State<SosScreen> {
  ...
  void _onHoldComplete() {
    Navigator.of(context).pushNamed(Routes.sosConfirmation);
  }
                      ...
                      onTap: () async {
                        if (service.id == 'child-safety') {
                          ...
                          if (groups.hasFamilyConsent) {
                            Navigator.of(context).pushNamed(Routes.childSafety);
                            return;
                          }
              ...
              builder: (context, _) {
                return Opacity(
                  ...
                  child: CustomPaint(
                    ...
                    painter: _HoldProgressPainter(progress: _controller.value),
                  ),
                );
              },
            ),
